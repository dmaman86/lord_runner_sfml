...
public:
	...
	StaticObj(sf::Vector2f pos, sf::Vector2f size, sf::Texture* txt);
	void virtual render(sf::RenderWindow* window)override;
	
	bool virtual collisionWithStand(Creature& obj, sf::Vector2f size) = 0;
	...
	void virtual handleColision(Creature& obj) = 0;// override; // important
